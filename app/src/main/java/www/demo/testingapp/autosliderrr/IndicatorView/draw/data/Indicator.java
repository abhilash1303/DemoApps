package www.demo.testingapp.autosliderrr.IndicatorView.draw.data;
...
public class Indicator {
    ...
    private www.demo.testingapp.IndicatorView.draw.data.Orientation orientation;
    private IndicatorAnimationType animationType;
    private www.demo.testingapp.IndicatorView.draw.data.RtlMode rtlMode;
    ...
    @NonNull
    public www.demo.testingapp.IndicatorView.draw.data.Orientation getOrientation() {
        if (orientation == null) {
            orientation = www.demo.testingapp.IndicatorView.draw.data.Orientation.HORIZONTAL;
        }
        return orientation;
    }

    public void setOrientation(www.demo.testingapp.IndicatorView.draw.data.Orientation orientation) {
    ...
    @NonNull
    public www.demo.testingapp.IndicatorView.draw.data.RtlMode getRtlMode() {
        if (rtlMode == null) {
            rtlMode = www.demo.testingapp.IndicatorView.draw.data.RtlMode.Off;
        }
        return rtlMode;
    }

    public void setRtlMode(www.demo.testingapp.IndicatorView.draw.data.RtlMode rtlMode) {

...
public class ColorAnimation extends www.demo.testingapp.autosliderrr.IndicatorView.animation.type.BaseAnimation<ValueAnimator> {
    ...
    public ValueAnimator createAnimator() {
        ...
        animator.setDuration(www.demo.testingapp.autosliderrr.IndicatorView.animation.type.BaseAnimation.DEFAULT_ANIMATION_TIME);

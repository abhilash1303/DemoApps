package www.demo.testingapp.autosliderrr.IndicatorView.animation.type;
...
public class ThinWormAnimation extends www.demo.testingapp.autosliderrr.IndicatorView.animation.type.WormAnimation {
    ...
    @Override
    public www.demo.testingapp.autosliderrr.IndicatorView.animation.type.WormAnimation with(int coordinateStart, int coordinateEnd, int radius, boolean isRightSide) {

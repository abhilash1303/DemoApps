...
import www.demo.testingapp.IndicatorView.draw.data.PositionSavedState;
import www.demo.testingapp.IndicatorView.draw.data.RtlMode;
import www.demo.testingapp.autosliderrr.IndicatorView.utils.CoordinatesUtils;
import www.demo.testingapp.autosliderrr.IndicatorView.utils.DensityUtils;
import www.demo.testingapp.autosliderrr.IndicatorView.utils.IdUtils;
...
public class PageIndicatorView extends View implements www.demo.testingapp.autosliderrr.SliderPager.OnPageChangeListener,
        IndicatorManager.Listener, www.demo.testingapp.autosliderrr.SliderPager.OnAdapterChangeListener {

    private IndicatorManager manager;
    private DataSetObserver setObserver;
    private www.demo.testingapp.autosliderrr.SliderPager viewPager;
    ...
    @Override
    public void onAdapterChanged(@NonNull www.demo.testingapp.autosliderrr.SliderPager viewPager, @Nullable PagerAdapter oldAdapter, @Nullable PagerAdapter newAdapter) {
        updateState();
    }
    ...
    public void setViewPager(@Nullable www.demo.testingapp.autosliderrr.SliderPager pager) {
        releaseViewPager();
        if (pager == null) {
            return;
        }
    ...
    private void findViewPager(@Nullable ViewParent viewParent) {
        ...
        www.demo.testingapp.autosliderrr.SliderPager viewPager = findViewPager((ViewGroup) viewParent, viewPagerId);
    ...
    @Nullable
    private www.demo.testingapp.autosliderrr.SliderPager findViewPager(@NonNull ViewGroup viewGroup, int id) {
        if (viewGroup.getChildCount() <= 0) {
            return null;
        }

        View view = viewGroup.findViewById(id);
        if (view != null && view instanceof www.demo.testingapp.autosliderrr.SliderPager) {
            return (www.demo.testingapp.autosliderrr.SliderPager) view;
        } else {
            return null;
        }
    }
